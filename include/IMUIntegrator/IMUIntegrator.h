#ifndef INCLUDE_IMUINTEGRATOR_IMUINTEGRATOR_H_
#define INCLUDE_IMUINTEGRATOR_IMUINTEGRATOR_H_
#include <Eigen/Core>
#include <mutex>
#include <queue>
...
class IMUIntegrator {
 public:
   ...
   */
  explicit IMUIntegrator(std::vector<sensor_msgs::msg::Imu::SharedPtr> vIMU);
...
#endif  // INCLUDE_IMUINTEGRATOR_IMUINTEGRATOR_H_
