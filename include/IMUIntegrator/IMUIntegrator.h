#ifndef LIO_LIVOX_INCLUDE_IMUINTEGRATOR_IMUINTEGRATOR_H_
#define LIO_LIVOX_INCLUDE_IMUINTEGRATOR_IMUINTEGRATOR_H_
...
class IMUIntegrator {
 public:
  ...
  /** \brief only integrate gyro information of each IMU message stored
   * in vimuMsg \param[in] lastTime: the left time boundary of vimuMsg
   */
 ...
 public:
  ...
  constexpr static const double kLidarM = 1.5e-3;
  constexpr static const double kGNorm = 9.805;
 ...
 private:
  std::vector<sensor_msgs::msg::Imu::SharedPtr> vimu_msg_;
...
#endif  // LIO_LIVOX_INCLUDE_IMUINTEGRATOR_IMUINTEGRATOR_H_
